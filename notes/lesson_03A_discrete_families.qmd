...
# Introduction
The Bernoulli Distribution, has PDF $f(k|p) \equiv p^k (1 - p)^{1 - k}$ 
...
We see that the product of the liklihoods is numerically 0 for large values of $n$. Let's switch to the log-likelihood (**add a section**).
