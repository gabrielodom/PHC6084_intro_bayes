...
$$X = \mu + \sigma * Z$$, Z follows standard normal distribution.
$$
\begin{align*}
M_z(t) 
&= E(e^{tz}) \\
...
= - \frac{1}{v} \sum_1^n (x_i - \mu) = 0
$$
$$
\frac{\partial \ell}{\partial v} 
= - \frac{n}{2v} + \frac{1}{2v^2} \sum_1^n (x_i - \mu)^2 = 0
$$
...
muHat
sigma2Hat <- sum((sample_normal - ex)^2)/10000
sigma2Hat
```
